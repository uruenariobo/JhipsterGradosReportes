...
public class PlanestudiosServiceImpl implements PlanestudiosService {
    ...
    public Optional<Planestudios> partialUpdate(Planestudios planestudios) {
        ...
        return planestudiosRepository
            ...
            .map(existingPlanestudios -> {
                if (planestudios.getProgramaid() != null) {
                    existingPlanestudios.setProgramaid(planestudios.getProgramaid());
                }
                if (planestudios.getFacultadid() != null) {
                    existingPlanestudios.setFacultadid(planestudios.getFacultadid());
                }
    ...
    public Page<Planestudios> findAll(Pageable pageable) {
