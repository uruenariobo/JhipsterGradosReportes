...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CEREMONIAGRADOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CEREMONIAGRADOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CEREMONIAGRADOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CEREMONIAGRADOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CEREMONIAGRADOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CEREMONIAGRADOS actions', async () => {
      const expectedActions = [
        {
