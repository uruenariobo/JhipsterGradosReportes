...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTUDIANTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTUDIANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTUDIANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTUDIANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTUDIANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTUDIANTES actions', async () => {
      const expectedActions = [
        {
