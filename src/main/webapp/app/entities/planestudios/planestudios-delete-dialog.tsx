...
import { getEntity, deleteEntity } from './planestudios.reducer';
...
export const PlanestudiosDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gradosApp.planestudios.delete.question">
        <Translate contentKey="gradosApp.planestudios.delete.question" interpolate={{ id: planestudiosEntity.id }}>
