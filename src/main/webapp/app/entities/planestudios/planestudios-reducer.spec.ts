...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANESTUDIOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANESTUDIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANESTUDIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANESTUDIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANESTUDIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANESTUDIOS actions', async () => {
      const expectedActions = [
        {
