...
class CeremoniagradosResourceIT {
    ...
    private static final LocalDate DEFAULT_FECHACEREMONIA = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FECHACEREMONIA = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_LIMITEINSCRIPCION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_LIMITEINSCRIPCION = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Ceremoniagrados createEntity(EntityManager em) {
        Ceremoniagrados ceremoniagrados = new Ceremoniagrados()
            .fechaceremonia(DEFAULT_FECHACEREMONIA)
            .limiteinscripcion(DEFAULT_LIMITEINSCRIPCION)
            .lugar(DEFAULT_LUGAR);
    ...
    public static Ceremoniagrados createUpdatedEntity(EntityManager em) {
        Ceremoniagrados ceremoniagrados = new Ceremoniagrados()
            .fechaceremonia(UPDATED_FECHACEREMONIA)
            .limiteinscripcion(UPDATED_LIMITEINSCRIPCION)
            .lugar(UPDATED_LUGAR);
        return ceremoniagrados;
    }
    ...
    void createCeremoniagrados() throws Exception {
        ...
        assertThat(testCeremoniagrados.getFechaceremonia()).isEqualTo(DEFAULT_FECHACEREMONIA);
        assertThat(testCeremoniagrados.getLimiteinscripcion()).isEqualTo(DEFAULT_LIMITEINSCRIPCION);
    ...
    @Test
    @Transactional
    void checkFechaceremoniaIsRequired() throws Exception {
        int databaseSizeBeforeTest = ceremoniagradosRepository.findAll().size();
        // set the field null
        ceremoniagrados.setFechaceremonia(null);
    ...
    @Test
    @Transactional
    void checkLimiteinscripcionIsRequired() throws Exception {
        int databaseSizeBeforeTest = ceremoniagradosRepository.findAll().size();
        // set the field null
        ceremoniagrados.setLimiteinscripcion(null);
    ...
    void getAllCeremoniagrados() throws Exception {
        ...
        restCeremoniagradosMockMvc
            ...
            .andExpect(jsonPath("$.[*].fechaceremonia").value(hasItem(DEFAULT_FECHACEREMONIA.toString())))
            .andExpect(jsonPath("$.[*].limiteinscripcion").value(hasItem(DEFAULT_LIMITEINSCRIPCION.toString())))
    ...
    void getCeremoniagrados() throws Exception {
        ...
        restCeremoniagradosMockMvc
            ...
            .andExpect(jsonPath("$.fechaceremonia").value(DEFAULT_FECHACEREMONIA.toString()))
            .andExpect(jsonPath("$.limiteinscripcion").value(DEFAULT_LIMITEINSCRIPCION.toString()))
    ...
    void putExistingCeremoniagrados() throws Exception {
        ...
        updatedCeremoniagrados.fechaceremonia(UPDATED_FECHACEREMONIA).limiteinscripcion(UPDATED_LIMITEINSCRIPCION).lugar(UPDATED_LUGAR);
        ...
        Ceremoniagrados testCeremoniagrados = ceremoniagradosList.get(ceremoniagradosList.size() - 1);
        assertThat(testCeremoniagrados.getFechaceremonia()).isEqualTo(UPDATED_FECHACEREMONIA);
        assertThat(testCeremoniagrados.getLimiteinscripcion()).isEqualTo(UPDATED_LIMITEINSCRIPCION);
